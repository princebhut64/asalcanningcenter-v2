...
(function () {
  ...
  function updateProductCount(
    ...
    if (
      ...
      countEl.innerText =
        `Showing all ${productsData.length} available formulations`;
    ...
    countEl.innerText =
      `Showing ${currentCount} of ${productsData.length} flagship formulations`;
